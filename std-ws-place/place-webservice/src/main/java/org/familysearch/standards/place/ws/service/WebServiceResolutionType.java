...
/**
 * The "Resolution-Type" service has end-points for retrieving information about
 * resolution types, as well as managing the creation, update and deletion of
 * these types.
 * 
 * @author dshellman, wjohnson000
 */
@Path(WebServiceResolutionType.URL_ROOT + "/" + TypeMapper.RESOLUTION_TYPE_PATH)
public class WebServiceResolutionType extends WebServiceGenericType {
     ...
     */
    public WebServiceResolutionType() { }
    ...
    TypeCategory getTypeCat() {
       return TypeCategory.RESOLUTION;
    }
