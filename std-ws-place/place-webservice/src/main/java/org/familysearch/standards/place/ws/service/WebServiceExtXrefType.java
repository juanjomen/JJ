...
/**
 * The "ExtXref-Type" service has end-points for retrieving information about
 * extXref types, as well as managing the creation, update and deletion of
 * these types.
 * 
 * @author dshellman, wjohnson000
 */
@Path(WebServiceExtXrefType.URL_ROOT + "/" + TypeMapper.EXT_XREF_TYPE_PATH)
public class WebServiceExtXrefType extends WebServiceGenericType {
