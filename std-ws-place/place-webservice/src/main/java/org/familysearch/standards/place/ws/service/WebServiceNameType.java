...
/**
 * The "Name-Type" service has end-points for retrieving information about
 * place name types, as well as managing the creation, update and deletion of
 * these types.
 * 
 * @author dshellman, wjohnson000
 */
@Path(WebServiceNameType.URL_ROOT + "/" + TypeMapper.NAME_TYPE_PATH)
public class WebServiceNameType extends WebServiceGenericType {
