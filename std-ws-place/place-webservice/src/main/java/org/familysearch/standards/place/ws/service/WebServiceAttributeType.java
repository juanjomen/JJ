...
/**
 * The "Attribute-Type" service has end-points for retrieving information about
 * attribute types, as well as managing the creation, update and deletion of
 * these types.
 * 
 * @author dshellman, wjohnson000
 */
@Path(WebServiceAttributeType.URL_ROOT + "/" + TypeMapper.ATTRIBUTE_TYPE_PATH)
public class WebServiceAttributeType extends WebServiceGenericType {
	 ...
	 */
	public WebServiceAttributeType() { }
