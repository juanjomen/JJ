...
public class WebServiceHealthCheck extends WebServiceBase {
  ...
  public Response heartbeat(
    ...
    if (getReadableService() != null) {
      isOK = true;
      log(null, "/healthcheck/heartbeat", WebConstants.METHOD_GET, Response.Status.OK.getStatusCode(), headers,
                                          WebConstants.MSG_TIME, "" + (System.currentTimeMillis() - startTime));
      return Response.ok().build();
   }
